  ...
  },
  {
    ...
    sources: [
      ...
      },
      {
        sourceType: 'cargo-lock',
        relativePath: 'Cargo.lock',
        packageName: 'pinocchio-token-2022',
        label: 'root-lockfile',
      },
      {
        sourceType: 'knowledge-table',
  ...
  },
  {
    ...
    sources: [
      ...
      },
      {
        sourceType: 'cargo-lock',
        relativePath: 'Cargo.lock',
        packageName: 'pinocchio-associated-token-account',
        label: 'root-lockfile',
      },
      {
        sourceType: 'knowledge-table',
